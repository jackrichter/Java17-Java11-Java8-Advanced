package org.advanced.java.LVTI;
...
public class LocalVariableTypeInference {
    ...
    // 3. A var is always initialized on the same statement where it is declared.
    //      e.g., var x = 8;
    ...
    // 6. var is not allowed in multi-variable declarations.
