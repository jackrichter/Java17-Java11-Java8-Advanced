...
public class SuperAndExtends {
    ...
    public static void main(String[] args) {      
        ...
        DogLocal[] dogs0 = {new DogLocal(), new DogLocal()};
        addAnimal(dogs0);
...
//        animals1.add(new Animal());// read-only
        List<? extends Animal> animals2 = new ArrayList<DogLocal>();
...
//        List<? extends Animal> animals6 = new ArrayList<Object>();
        ...
        List<? super DogLocal> dogs1 = new ArrayList<DogLocal>();
        dogs1.add(new DogLocal()); // now, can add to the list
        List<? super DogLocal> dogs2 = new ArrayList<Animal>();
        List<? super DogLocal> dogs3 = new ArrayList<Object>();
//        List<? super DogLocal> dogs4 = new ArrayList<Terrier>();
        ...
        List<DogLocal> dogs = new ArrayList<>();
...
//        list.add(new DogLocal());    // compiler error - Dog is not a Cat
...
//        list.add(new DogLocal());      // compiler error if we try to modify 'list'
//        list.add(new Animal());   // compiler error if we try to modify 'list'
//        for(DogLocal dog:list){        // compiler errors reading - 'list' could be a list of Cat's
