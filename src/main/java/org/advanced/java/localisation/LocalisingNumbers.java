...
public class LocalisingNumbers {
    ...
    public static void formatNumbers(){
        ...
        System.out.println(Locale.getDefault().getDisplayLanguage() + "_" + Locale.getDefault().getDisplayCountry());
    ...
    public static void parseCurrencies(){
        ...
        try {
            System.out.println(NumberFormat.getCurrencyInstance(new Locale("en", "IE")).parse(irishCurrency));       // 23.22
